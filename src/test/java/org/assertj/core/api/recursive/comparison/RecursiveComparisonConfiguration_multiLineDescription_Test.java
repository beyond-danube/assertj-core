...
class RecursiveComparisonConfiguration_multiLineDescription_Test {
  ...
  void should_show_a_complete_multiline_description() {
    ...
    then(multiLineDescription).isEqualTo(format(
               ...
               "- the comparison was performed on the following fields of types: java.lang.String, java.lang.Integer%n" +
  ...
  void should_show_that_comparison_is_performed_on_given_fields_of_types() {
    ...
    String multiLineDescription = recursiveComparisonConfiguration.multiLineDescription(STANDARD_REPRESENTATION);
    // THEN
    then(multiLineDescription).contains(format("- the comparison was performed on the following fields of types: java.lang.String, java.lang.Integer%n"));
  }
